...
import {Queen} from './pieces-classes/queen';
            ...
            if (piece.piece && 
                ...
                ) 
                {
                    ...
                    if (piece.piece == 'queen') {
                        this['board'][piece.positionX][piece.positionY] = new Queen(piece.color, piece.piece, this, piece.positionX, piece.positionY);
                    }
                }
